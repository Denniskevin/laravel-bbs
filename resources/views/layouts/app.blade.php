...
<head>
    ...
    <meta name="author" contents="csbbs.com">
...
<footer id="footer">
    <div class="container">
        <div class="pull-right hidden-xs">
            ...
            <a href="http://dev4living.com" target="_blank">laravel</a><a>/</a><a href="https://getbootstrap.org" target="_blank">Bootstrap</a>
        </div>
        <i class="fa fa-lightbulb-o"></i> {{ $systemDatas->site_slogan }}
        <div class="visible-xs">
            <i class="fa fa-plug"></i> Powered by
            <a href="http://csbbs.com" target="_blank">laravel</a><a>/</a><a href="https://getbootstrap.org" target="_blank">Bootstrap</a>
        </div>
    </div>
</footer>
<div class="hidden">
